...
function Form(): JSX.Element {
  ...
  return (
    <div
      ref={ref}
      className="secao secao-contato h-full form-otimizza w-full px-3 py-10 xlg:px-16 xlg:py-11 gap-2.5 font-azonix text-snow-white"
    >
      <div className="bg-[#2C3A64BF] flex flex-col gap-5 py-4 rounded-xl">
        <div className="text-center">
          <h1 className="text-2xl sm:text-5xl">Entre em contato</h1>
          <h5 className="text-sm mx-2 sm:mx-0 font-montserrat">
            Explore os serviços personalizados da Otimizza hoje mesmo, sem custo
            inicial!
          </h5>
        </div>
        <form
          action=""
          className="flex flex-col gap-1 sm:flex-row justify-around"
        >
          <div className="flex-grow font-montserrat mx-3">
            ...
            <div className="flex flex-col my-8 sm:my-2">
              ...
              <textarea
                ...
                className="border text-iron-gray border-gray-400 p-2 rounded-md min-h-28"
              ></textarea>
            </div>
          </div>
        ...
        <div className="flex justify-end mr-4">
          <button
            type="button"
            className="font-semibold w-40 h-10 text-2xl px-7 py-1 rounded-md font-montserrat bg-[#FFB800]"
          >
            ENVIAR
          </button>
        </div>
