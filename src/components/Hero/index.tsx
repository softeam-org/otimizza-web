...
export default function Hero() {
  return (
    <div className="items-center justify-center max-w-[1600px] flex flex-col">
      <Slider />
      <div className="flex flex-row gap-16 items-center justify-center p-8 md:p-12">
        <img
          src={presentation}
          className="w-[450px] h-[300px] object-cover hidden md:block"
        />
      ...
      <div className="flex flex-col p-6 bg-golden-brown w-full items-center justify-center text-white">
        <h3 className="font-azonix text-md md:text-lg">
          Economize, Planeje, Otimizze!
        </h3>
        <div className="flex flex-row gap-1">
          <Envelope width={24} height={24} />
          <p className="font-montserrat">contato@otimizzaengenharia.com</p>
        </div>
        <div className="flex flex-row gap-1">
          <Phone width={24} height={24} />
          <p className="font-montserrat">(74) 9 8145-4940 / 9 9975-5335</p>
        </div>
      </div>
    </div>
  );
